...
/**
 * The class accumulate is used for collecting time-weighted data
 * generated by queues. It contains multiple Lists, one containing
 * entry times and one containing exit times.
 */
public class Accumulate extends Statistic {
    ...
    /**
     * Arraylist containing ListEntries. Each ListEntry consists
     * of a value, i.e. the queue size, and a reference to
    ...
    /**
     * Arraylist containing only the time of exists. Used for calculating
     * queue time of a single entity.
     */
    ...
    /**
     * Creates a new ListEntry with the passed with value and the
    ...
    /**
     *  Method checks list size concerning evenness.
     *  Calculates Quantiles accordingly.
     * @return quantile object containing the calculated first quantile,
    ...
    /**
     * Weighs list values with the time of change,
     * resulting in a time weighted mean, used for waiting times.
    ...
    /**
     * Calculates time difference between the entry time
     * and the exit time of one entity. Saves these values in the
    ...
    /**
     * Adds default value to the list so that findexists()
     * can run smoothly and does not result in an out of bounds error.
     */
    ...
    /**
     *
     * @return WaitingTimeReport containing each significant
     * value concerning queue waiting times.
     */
    @Override
